...
parse.add_argument('--restore_model', type=str, default='',
                    help='path to  model')
parse.add_argument('--input_path', type=str, default='only_text_tokenized.txt',
                    help='path to the training corpus')
parse.add_argument('--n_epochs', type=int, default=5, help='number of epochs')
parse.add_argument('--n_workers', type=int, default=4, help='number of workers')
parse.add_argument('--size', type=int, default=100, help='embedding size')
...
if len(args.restore_model) > 0:
    ...
    model = Word2Vec(size=args.size, workers=args.n_workers)
